...
from src import ARTIFICIAL_NODE_STARTING_STRING
from src.scenarios_chronic import Scenario
import src.env
...
class Grid(object):
    ...
    def export_to_observation(self):
        ...
        return src.env.RunEnv.Observation(active_loads, reactive_loads, voltage_loads,
